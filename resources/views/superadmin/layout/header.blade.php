                ...
                <div class="nav-wrapper">
                    <div class="header-search-wrapper hide-on-med-and-down"><i class="material-icons">search</i>
                        <input class="header-search-input z-depth-2" type="text" name="Search"
                            placeholder="Search" data-search="template-list">
                    ...
                    <ul class="navbar-list right">
                        ...
                        <li class="hide-on-med-and-down"><a
                         ...
                         -->
                        <!-- <li class="subscribe-btn"><a class="waves-effect waves-block waves-light"
                                href="#"><span>Subscribe</span></a></li> -->
                        ...
                        <li><a class="waves-effect waves-block waves-light notification-button"
                                href="javascript:void(0);" data-target="notifications-dropdown"><i
                                    class="material-icons">notifications_none<small
                                        class="notification-badge">0</small></i></a></li>
                        <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
                                data-target="profile-dropdown"><span class="avatar-status avatar-online"><img
                                        src="{{'assets/user/'.Auth::user()->profile_image}}" alt="avatar"></span></a>
                        </li>
                    ...
                    <ul class="dropdown-content" id="profile-dropdown">
                        <li><a class="grey-text text-darken-1" href="{{url('userprofile')}}"><i
                                    class="material-icons">person_outline</i> Profile</a></li>
                        <li><a class="grey-text text-darken-1" href="{{url('chat')}}"><i
                                    class="material-icons">chat_bubble_outline</i> Chat</a></li>
                        <!-- <li><a class="grey-text text-darken-1" href="help.php"><i
                                    class="material-icons">help_outline</i> Help</a></li> -->
                        <li class="divider"></li>

                        <!-- <li><a class="grey-text text-darken-1" href="user-detail.php"><i
                                    class="material-icons">help_outline</i> Details</a></li>
                        <li class="divider"></li> -->

                        <li><a class="grey-text text-darken-1" href="{{url('user-lock')}}"><i
