...
<body
                  ...
                  <div class="listing-container form-container">
                     <div class="listing-header">
                                    ...
                                    <div class="action-btns">
                                        ...
                                        <a class="waves-effect waves-light btn add-list-btn" href="legionella-add-new-contact.php"><span><i class="fa fa-plus"
   ...
   <div id="modal2" class="modal showdiaries-modal">
        ...
        <div class="modal-content">
                           ...
                           <div class="modal-content-boby-scroll">
                              <a href="legionella1-1.php">
                                 <div class="listing-body">
                                    <h4>Project Created on 27/11/2020</h4>
                                    <p>Demo Company</p>
          ...
          <div class="row">
              <div class="s12">
                  <a href="create-new-legionella-project.php" class="modal-app-btn"><i class="fa fa-times"></i> None of the above</a>
              </div>
          </div>
        </div>
      </div>
