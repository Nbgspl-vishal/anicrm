               ...
               <div class="section">
                  ...
                  <div class="listing-container form-container">
                     <div class="row">
                        <div class="s12">
                           <div class="card">
                              <div class="card-head">Cold Water System</div>
                              <div class="card-content">
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Is a cold water tank present?</label>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Is the tank accessible?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Is the tank located in a cool place and protected from extreme tempratures?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Is the water in the below 20°C?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Is the tank insulated to prevent the temprature rising above 20°C?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Is the tank fitted with a cover and insect screen(s) on any pipework open to atmosphere?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Is the water in the tank clean and free from debris, scale etc?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Are lesser used autlets installed upstream og heigher usage outlets?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
