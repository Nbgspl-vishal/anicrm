                              ...
                              <div class="card-content">
                                 <div class="row">
                                    <div class="col l3 m4 s12">
                                       <a href="plumbing-create-new-contact.php" class="btn btn-info btn-block">Less Details</a>
                                    </div>
                                    <div class="col l3 m4 s12">
                                       <a href="plumbing-new-contact-more-detail.php" class="btn btn-info btn-block">More Details</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="col l12 m12 s12">
                                 ...
                                 <div style="display:none;" id="third1t"
                                    ...
                                    <div class="card-content">
                                       ...
                                       <a href="plumbing-addnewsite.php" class="btn btn-info btn-md"><i class="fa fa-plus mr-2"></i>Addnew site</a>
                                    </div>
                                 </div>
