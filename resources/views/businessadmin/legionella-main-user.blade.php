               ...
               <div class="section">
                  ...
                  <div class="listing-container form-container">
                     ...
                     <div class="row">
                        <div class="s12">
                           <div class="card">
                              <div class="card-head">User Detail</div>
                              <div class="card-content">
                                 <div class="row">
                                    <div class="col l6 m6 s12">
                                       <div class="input-field">
                                          <input type="text" value="Petrick">
                                       </div>
                                    </div>

                                    <div class="col l6 m6 s12">
                                       <div class="input-field">
                                          <input type="text" value="Meehan">
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <input type="email" value="info@safehelthboiler.co.uk">
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col l6 m6 s12">
                                       <div class="input-field">
                                          ...
                                          <small>Password must contain at least one number, one lowercase letter, and must be at least six characters.</small>
                                       </div>
                                    </div>
                                    ...
                                    <div class="border-card-detail row">
                                       <div class="col s12">
                                         <div class="border-card-detail-btn">
                                             <a href="signature-main-legionella-user.php" class="btn btn-info"><i class="fa fa-plus"></i> Set signature</a>
                                         </div>
                                       </div>
                                    </div>
                                 </div>
