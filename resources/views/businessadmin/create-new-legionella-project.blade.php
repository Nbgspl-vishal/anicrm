                  ...
                  <div class="listing-container form-container">
                     ...
                     <div class="row">
                        <div class="s12">
                           <div class="card">
                              <div class="card-head">
                                 Customer Detail & Project Name
                              </div>
                              <div class="card-content">

                                 <div class="row">
                                    <div class="col l6 m6 s12">
                                       <div class="create-new-project1">
                                          <h6><i class="fa fa-home mr-2"></i>Main Content</h6>
                                          <p>John Appleseed</p>
                                          <p>Demo Company</p>
                                          <p class="submitted-title">LITTEL COTTAGE 17 HIGH STREET, GRAFTY VALLEY BIG CITY</p>
                                          <P class="submitted-title">TRADITIONAL COUNTRY</P>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col l6 m6 s12">
                                       <div class="input-field">
                                          ...
                                          <input type="text" value="Project Created on 27/11/2020">
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="s12">
                           <div class="card">
                              ...
                              <div class="card-content">
                                 ...
                                 <div class="row">
                                    <div class="allcreate-colom">
                                       <div class="create-new-project2">
                                          <h6><i class="fa fa-home mr-2"></i>Main Content</h6>
                                          <p>John Appleseed</p>
                                          <p>Demo Company</p>
                                          <p class="submitted-title">LITTEL COTTAGE 17 HIGH STREET, GRAFTY VALLEY BIG CITY</p>
                                       ...
                                       <div class="create-new-project2">
                                          <h6><i class="fa fa-home mr-2"></i>Invoicing Content</h6>
                                          <p>Colleen Davidson</p>
                                          <p class="submitted-title">3 HIGH STREET, GRAFTY VALLEY BIG CITY</p>
                                          <P class="submitted-title">TRADITIONAL COUNTRY</P>
                                       </div>
                                    
                                       <div class="create-new-project2">
                                          <h6><i class="fa fa-home mr-2"></i>Registered Address</h6>
                                          <p>Demo Company</p>
                                          <p class="submitted-title">23 HIGH STREET, GRAFTY VALLEY BIG CITY</p>
                                          <P class="submitted-title">TRADITIONAL COUNTRY</P>
                                       </div>
                                    
                                       <div class="create-new-project2">
                                          <h6><i class="fa fa-home mr-2"></i>Site</h6>
                                          <p>Cody Myers</p>
                                          <p>Demo Company</p>
                                          <p class="submitted-title">LITTEL COTTAGE 17 HIGH STREET, GRAFTY VALLEY BIG CITY</p>
                                          <P class="submitted-title">TRADITIONAL COUNTRY</P>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <button class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add new site</button>

                                       <a href="gas1-1.php" class="btn btn-info">Next</a>
                                    </div>
                                 </div>
