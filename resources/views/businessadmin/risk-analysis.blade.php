                  ...
                  <div class="listing-container form-container">
                     <div class="row">
                        <div class="s12">
                           <div class="card">
                              <div class="card-head">
                                 Risk Analysis of Kitchen Ventilation/ Air Quality Systems
                              </div>
                              <div class="card-content">
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Has risk assessment been applied in accordance with IGEM/UP/19?</label>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is applicable, what is the outcome of the risk assessment?</label>
                                          <select class="browser-default">
