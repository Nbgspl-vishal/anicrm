                  ...
                  <div class="listing-container form-container">
                     <div class="row">
                        <div class="listing-header addhead-text">
                           <h5 class="web-head">Add Installed Parts </h5>
                        </div>
                        <div class="add-form">
                           <form>
                              <div class="card form-card">
                                <div class="card-head card-head-text ">
                                 ...
                                 <div class="card-content">
                                    ...
                                    <div class="row">
                                       <div class="input-field col s12 m6">
                                          <input type="checkbox" class="checkbox" id="search-part" /> 
                                          <label for="search-part">Search Part Database</label>

                                          <input type="checkbox" class="checkbox ml-5" id="add-new" /> 
                              ...
                              <div class="card form-card">
                                 ...
                                 <div class="card-content">
                                    ...
                                    <div class="row">
                                       <div class="input-field col s12 m6">
                                          <input type="checkbox" class="checkbox" id="add-new-database" /> 
                                          <label for="add-new-database">Add New Part to Database?</label>
                                       </div>
                                    </div>
