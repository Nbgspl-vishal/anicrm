                        ...
                        <div class="listing-container">
                            ...
                            <div class="row">
                                ...
                                <div class="listing-header">
                                    ...
                                    <h5 class="web-head">Installed Parts</h5>

                                    <div class="action-btns">

                                        <a href="addparts.php" class="waves-effect waves-light btn add-list-btn"><span><i class="fa fa-plus"

                                                    aria-hidden="true"></i>add installed parts</span></a>
                                                ...
                                                <form class="web-form">
                                                    ...
                                                    <div class="formfield">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="Installed Parts / Customer / Site / Description / Class / Location / Number / Serial no. / System ID / Reference / Make / Model" />
                                                        ...
                                                        <table id="" class="dat_table">
                                                            ...
                                                            <thead>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>Labour warranty Expiry Date</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><span class="head-td">Sample name</span></td>
                            ...
                            <div class="row">
                                ...
                                <div class="slide-out-right-body row pl-3">
                                    ...
                                    <div id="settings" class="col s12">
                                        ...
                                        <p class="setting-header mt-8 mb-3 ml-5 font-weight-900">GENERAL
                                        ...
                                        <p class="setting-header mt-7 mb-3 ml-5 font-weight-900">SYSTEM SETTINGS
                                        ...
                                        <div class="activity">
                                            ...
                                            <ul class="widget-timeline mb-0">
                                                ...
                                                <li class="timeline-items timeline-icon-cyan active">
                                                    ...
                                                    <h6 class="timeline-title">Melissa liked your activity

                                                        Drinks.

                                                    </h6>

                                                    <p class="timeline-text">Here are some news feed
                                                ...
                                                <li class="timeline-items timeline-icon-indigo active">
                                                    ...
                                                    <h6 class="timeline-title">Tina is attending your activity
                                ...
                                <ul class="collection">
                                    ...
                                    <li class="collection-item display-flex avatar pl-5 pb-0"
                                        ...
                                        <div class="user-content speech-bubble">
                                            ...
                                            <p class="medium-small">I am looking for the best admin template.?
