...
<body
    ...
    <div id="main">
        <div class="row">
            <div class="col s12">
                <div class="container">
                    <div class="section non-top-padded">
                        <!-- dashboard initail row -->
                        <div class="dashboard-initial">
                            <div class="row">
                                <div class="col s12 m8">
                                    <div class="dashboard-initial-main-content">
                                        <div class="dashboard-initial-main-inner">
                                            <div class="dashboard-init-top">
                                                <h5 class="web-head">Explore ANI</h5>
                                                <p>Welcome to your learning hub that will assist you in trialling the
                                                    ANI CRM.</p>
                                            </div>
                                            <div class="dashboard-init-tabs">
                                                <div class="di-tabs-list">
                                                    <ul>
                                                        <li class="active-di-tab"><a href="#">Back Office</a></li>
                                                        <li><a href="#">Mobile Workforce</a></li>
                                                        <li><a href="#">Customers</a></li>
                                                        <li><a href="#">System Setup</a></li>
                                                    </ul>

                                                </div>
                                                <div class="di-tab-content"></div>
                                            </div>
                                ...
                                <div class="col s12 m4">
                                    <div class="dashboard-initial-rightside">
                                        <div class="book-demo col s12">
                                            <div class="bookdemo-inner">
                                                <h5 class="u-head">Book a Demo</h5>
                                                <p>Learn how to use all of Joblogic’s features and functionalities with
                                                    a
                                                    virtual screen sharing session.</p>
                                                <a class="waves-effect waves-light btn">
                                                    Book a Demo</a>
                                            </div>
                                        </div>
                                        <div class="my-details col s12">
                                            <div class="my-details-inner">
                                                <h5 class="u-head floated-left">My Details</h5>
                                                <a class="waves-effect waves-light btn edit-details"><span><i
                                                            class="fas fa-edit"></i>Edit</span></a>
                                                <p>To see the right functionality, it is important your details are
                                                    correct.
                                                </p>
                                                <form class="web-form">
                                                    <div class="formfield">
                                                    ...
                                                    <div class="formfield half-field pad-r">
                                                        <label>Telephone</label>
                                                        <input type="text" />
                                                    </div>

                                                    <div class="formfield half-field pad-l">
                                                    ...
                                                    <div class="formfield">
                                                        ...
                                                        <select class="browser-default">
                                                            <option>This is test option</option>
                                                            <option>This is test option</option>
                                                            <option>Other</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="formfield">
                                                        <label>Number of licences required</label>
                                                        <select class="browser-default">
                                                            <option>This is test option</option>
                                                            <option>This is test option</option>
                                                            <option>Other</option>
                                                ...
                                                <a class="waves-effect waves-light btn full-btn">
                                                    Visit Knowledge Base</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
