                     ...
                     <div class="row">
                        <div class="s12">
                           <div class="row">
                              <div class="col s12">
                                 <div class="card">
                                    <div class="card-head">Add Site Contact</div>
                                    <div class="card-content">
                                       <p>Add a site and optional site contact.</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                                          ...
                                          <div class="row">
                                             <div class="col s12">
                                                <div class="input-field">
                                                   <input type="checkbox" class="checkbox" id="useplot">
                                                   <label for="useplot">This site is divided into plots or numbers. By choosing this you can work on multiple plots or numbers within a project.</label>
                                                </div>
                                             </div>
                                          </div>
                                       </form>
                              ...
                              <div class="card-content">
                                 <form>
                                    <div class="row">
                                       <div class="col s12">
                                          <div class="input-field">
                                             <input type="checkbox" class="checkbox" id="document-setting">
                                             <label for="document-setting">Use site address on job sheets</label>
                                          </div>
                                       </div>
                                    </div>
                                 </form>
