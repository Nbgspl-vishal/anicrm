               ...
               <div class="section">
                  ...
                  <div class="listing-container form-container">
                     <div class="row">
                        <div class="s12">
                           <div class="card">
                              <div class="card-head">Hot Water System</div>
                              <div class="card-content">
                                 <div class="row">
                                    <div class="col l6 m6 s12">
                                       <div class="input-field">
                                          <label>Is the hot water heated to a temperature of 60°C?</label>
                                    ...
                                    <div class="col l6 m6 s12">
                                       <div class="input-field">
                                          <label>Are the hot water distribution pipes insulated sufficiently?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="input-field">
                                          <label>Is a clorifier fitted?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                 ...
                                 <div class="row">
                                    <div class="col s12">
                                       <div class="card-form-content">
                                          <h5>If Yes, is the unit fitted with</h5>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col l6 m6 s12">
                                       <div class="input-field">
                                          <label>A temperature gauge on the inlet and outlet? </label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col l6 m6 s12">
                                       <div class="input-field">
                                          <label>If more than one calorifier is fitted, are they connected in parallel?</label>
                                          <select class="browser-defaul">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
