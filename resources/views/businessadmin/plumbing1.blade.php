...
<body
                  ...
                  <div class="listing-container form-container">
                     <div class="listing-header">
                                    ...
                                    <div class="action-btns">
                                        ...
                                        <a class="waves-effect waves-light btn add-list-btn" href="plumbing-create-new-contact.php"><span><i class="fa fa-plus"
   ...
   <div id="modal2" class="modal showdiaries-modal">
        ...
        <div class="modal-content">
          ...
          <div class="row">
              <div class="s12">
                  <a href="create-new-plumbing-project.php" class="modal-app-btn"><i class="fa fa-times"></i> None of the above</a>
              </div>
          </div>
        </div>
      </div>
