                  ...
                  <div class="listing-container form-container">
                     <div class="row">
                        <div class="s12">
                           <div class="card">
                              <div class="card-head">
                                 Vantilation & Are Quality Systems
                              </div>
                              <div class="card-content">
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is a canopy system installed?</label>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: is the canopy overhang correct?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Type of filtration?</label>
                                          <input type="text">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Filtration adequately maintained?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is mechanical axhaust provided?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: is the flow rate adequate?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is mechanical ventilation provided?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is exhaust/ventilation lock provided?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: interlock working correctly?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is natural ventilation provided? (Permanent)</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: is the area adequate?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
