                           ...
                           <div class="card">
                              ...
                              <div class="card-content">
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is an emergency control valve installed in catering area?</label>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: Is the location of ECV Satisfactory?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: Is the ECV accessible?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: Is the appropriate valve type installed?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: Is the valve handle securely attached?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is a gas emergency notice present on site?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is gas isolation via an auto electric system?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: Is the system fitted with automatic pressure proving?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: Do all appliance burners have flame safeguards?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Alternatively, is the system manually reset?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: is there a notice attached regarding resetting?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Is there any evidence of corrosion of gas pipework?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>If Yes: detail any action required</label>
                                          <input type="text">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Has the gas installation been tested for tightness?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                 ...
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Was the gas tightness satisfactory?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
