               ...
               <div class="section">
                  ...
                  <div class="listing-container form-container">
                     ...
                     <div class="row">
                        <div class="s12">
                           <div class="card">
                              <div class="card-head">Appliance Record Sheet</div>
                              <div class="card-content">
                                 <p>Add the detail of any appiliances here.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="card">
                              <div class="card-content">
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          ...
                                          <select class="browser-default">
                                             <option>Combi Boiler Cenwat 1</option>
                                             <option>System Boiler Cenwat 1</option>
                                             <option>Water Heater Cenwat 1</option>
                                             <option>Hob CKR 1</option>
                                             <option>Range Cooker Slot in CKR 1</option>
                                             <option>Free Standing Cooker with eye level grill CKR 1</option>
                                          </select>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Manufacturer's instructions available?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                 ...
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>FSD fitted to all burners?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                 ...
                                 <div class="row">
                                    <div class="s12">
                                       <div class="input-field">
                                          <label class="ml-1">Operating pressure(mbar) and/or heat input(kw)</label>
                                       </div>
                                    </div>
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                 ...
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>All appliance safety devices (including FSDs) operating correctly?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Adequate ventilation arrangement?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                 ...
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Appliance gas isolation valve or self-sealing plug and socket fitted?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
                                    ...
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Adequate appliances fitted with appropriate gas hose with restraint fitted correctly?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                             <option>N/A</option>
                                 ...
                                 <div class="row">
                                    <div class="col l6 m12 s12">
                                       <div class="input-field">
                                          <label>Appliance pipework gas tight?</label>
                                          <select class="browser-default">
                                             <option>Yes</option>
                                             <option>No</option>
                                          </select>
